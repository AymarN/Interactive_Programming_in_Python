...
# to the gold that the Avatar is carrying.
    ...
    def find_gold(self, amount):
        #pass# replace this line or delete it
        self.amount = amount
        self.initial_gold += self.amount
        return self.initial_gold
...
# in the Avatar's bag by 10%.
    ...
    def sprinkled_with_fairy_dust(self):
        #pass# replace this line or delete it
        self.initial_gold += (self.initial_gold * 10) / 100
        return self.initial_gold
...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        #pass# replace this line or delete it
        s = " The Avatar Name " + self.name
        s += " The amount of gold carried " + str(self.initial_gold)
        s += " The amount of gold burried " + str(self.buried)
        return s
...
print "=============================="
print "check totals here: Wild Girl should have 5.75 gold in bag, and 2.5 gold buried."
print wildgirl
print "=============================="
...
madmax.sprinkled_with_fairy_dust()
print "=============================="
print "check totals here: Mad Max should have 28.3195 gold in bag, and 21.5 gold buried."
print madmax
print "=============================="
